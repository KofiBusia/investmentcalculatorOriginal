"""Resend Osei Agyemang Sarfo's certificate as both PNG and PDF."""
import io, os
...
NAME        = "Osei Agyemang Sarfo"
EMAIL       = "oseiagyemangsarfo@gmail.com"
BLANK_TOP   = 1760
UNDERLINE_Y = 2072
  ...
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.08);">
      ...
      <tr><td style="padding:36px 36px 28px;">
        <p style="margin:0 0 16px;font-size:15px;color:#374151;">Dear Osei,</p>
...
print(f"Sent to {EMAIL} — PNG + PDF attached.")
